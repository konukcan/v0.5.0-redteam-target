// TODO: add additional attributes if you want, such as updating progress bar
const feedback_demographics = {
    ...
    on_finish: function(data) {
        ...
        // Ensure feedback has no newlines or commas
        response.feedback = response.feedback.replace(/[\n,]/g, ' ');
